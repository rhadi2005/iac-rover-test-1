      ...
      share1 = {
        ...
        files = {
          file1 = {
            ...
            source = "/tf/caf/configuration/level3/104-file-share-with-backup/fileA"
          }
          file2 = {
            name   = "fileB"
            source = "/tf/caf/configuration/level3/104-file-share-with-backup/fileB"
            path   = "testdirectory"
          }
          file3 = {
            name   = "fileC"
            source = "/tf/caf/configuration/level3/104-file-share-with-backup/fileC"
            path   = "testdirectory"
          }
        }

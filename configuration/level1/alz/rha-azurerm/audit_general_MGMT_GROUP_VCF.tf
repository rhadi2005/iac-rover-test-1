...
resource "azurerm_management_group_policy_assignment" "audit_general_MGMT_GROUP_VCF" {
  ...
  policy_definition_id = azurerm_policy_set_definition.audit_general_MGMT_GROUP_VCF.id
